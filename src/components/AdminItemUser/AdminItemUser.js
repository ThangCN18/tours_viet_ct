...
function AdminItemUser(props) {
    ...
    const handerChangeRole = async (e) => {
        ...
        await axios({
            method: "PATCH",
            headers: token,
            url: "https://server-tour-18.herokuapp.com/user/role/" + user._id + "/",
            data: { role: valuerole }
        }).then(result => {
            ...
            axios({
                method: 'get',
                headers: token,
                url: "https://server-tour-18.herokuapp.com/user/",
            }).then(result => {
    ...
    const handerDeleteUser = async (e) => {
        ...
        await axios({
            method: "delete",
            headers: token,
            url: "https://server-tour-18.herokuapp.com/user/" + user._id + "/",
        }).then(result => {
