...
function ProfilePage() {
  ...
  const [messagechange, setmessagechange] = useState("");
    ...
    const handelChaneImage = e =>{
      ...
      const url = "https://server-tour-18.herokuapp.com/user/image/" + user.user._id
      axios({
        method: "patch",
        url: url,
    ...
    const handelChanePass = e =>{
      ...
      const url = "https://server-tour-18.herokuapp.com/user/update-pass/" + user.user._id
      axios({
        method: "patch",
        url: url,
        headers: {token: "token " + user.token},
    ...
    const handelEditUser = e =>{
      const url = "https://server-tour-18.herokuapp.com/user/" + user.user._id
      axios({
        method: "patch",
        url: url,
        headers: {token: "token " + user.token},
