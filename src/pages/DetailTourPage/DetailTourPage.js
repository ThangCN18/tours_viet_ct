...
function DetailTourPage() {
    ...
    const handelEditReview = e =>{
        ...
        const url_edit =  "https://server-tour-18.herokuapp.com/review/" + isreviewed._id
        axios({
            method: "patch",
            url: url_edit,
    ...
    const handelAddReview = e =>{
        if(tour){
            const urrel = "https://server-tour-18.herokuapp.com/review/" + id_tour
            axios({
                method: "post",
                url: urrel,
                headers: {token: "token " + user.token},
    ...
    const handeldeleteReview = e =>{
        if(tour){
            const url_del = "https://server-tour-18.herokuapp.com/review/" + isreviewed._id
            axios({
                method: "delete",
                url: url_del,
                headers: {token: "token " + user.token},
    ...
    useEffect(() => {
        ...
        const url = "https://server-tour-18.herokuapp.com/tour/" + id_tour
        if(notify.isNotify ){
        ...
        axios({
            ...
            setTour(a)
            const urrl = "https://server-tour-18.herokuapp.com/tour/category/" + id_tour+"/?c="+a.category
            axios({
                method: "get",
                url: urrl
            ...
            const urrrl = "https://server-tour-18.herokuapp.com/tourtrip/yetdeparted/" + id_tour
            axios({
                method: "get",
                url: urrrl,
            ...
            const urrrrl = "https://server-tour-18.herokuapp.com/review/" +id_tour
            axios({
                method: "get",
                url: urrrrl,  
            }).then(result =>{
    ...
    const handelBooking = (e)=>{
        ...
        const urrrl = "https://server-tour-18.herokuapp.com/booktour/" + tourtripch._id
            axios({
                method: "post",
                url: urrrl,
                headers: {token: "token "+ user.token},
